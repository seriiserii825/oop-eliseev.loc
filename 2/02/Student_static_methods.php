...
class Student
{
	 ...
	 */
	public static function loadStudentsFromTxt($file){
		$rows = file($file);
	...
	public static function saveStudentsToFile(array $students, $file){
		$rows = [];
...
Student::loadStudentsFromTxt($fileName);

foreach ($students as $student) {
	echo $student->getFullName() . ' ' . $student->birthDay.PHP_EOL;
}

Student::saveStudentsToFile($students, $fileName);
